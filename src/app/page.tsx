...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-slate-900">
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-8 py-4 bg-white shadow-sm" style={{paddingLeft: "11%", paddingRight: "11%"}}>
      ...
      <section id="home" className="pt-20" style={{background: "linear-gradient(to bottom,white,rgb(200,225,255))"}}>
        {/* Hero Section */}
        <section className="text-center py-20 px-6">
          ...
          <a className="register-button" href="/contact" style={{border: "1px solid blue"}}>
      ...
      <section id="testimonials" className="pt-20 text-center" style={{paddingLeft: "20%", paddingRight: "20%"}}>
