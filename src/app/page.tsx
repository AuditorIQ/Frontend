  ...
  return (
    <div className="min-h-screen text-slate-900">
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-8 py-4 bg-white shadow-sm" style={{paddingLeft: "15%", paddingRight: "15%"}}>
        <button onClick={() => window.location.href="/"} style={{cursor: "pointer"}}><img src="logo_asset.svg" style={{width: "200px" }} /></button>
        <Navbar />
        {/* Register Button */}
        { showRegisterButton &&
      ...
      <section id="home" className="pt-10" style={{background: "linear-gradient(to bottom, white 0%, rgb(200, 225, 255) 50%, white 100%)"}}>
        ...
        <section className="text-center py-20 px-6">
          ...
          <a className="contact-button flex items-center" href="/contact" style={{border: "1px solid blue"}}>
      ...
      <section id="about" className="pt-10">
        ...
        <section className="text-center pt-20 px-6 bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mx-auto" style={{paddingLeft: "20%", paddingRight: "20%"}}>
            {[
              {
      ...
      {/* <section id="testimonials" className="pt-10 text-center" style={{paddingLeft: "20%", paddingRight: "20%"}}>
      <p className="text-sm text-blue-600 font-medium mb-2">Testimonials</p>
      ...
      <div className="space-y-16 px-8 pt-20 mx-auto" style={{paddingLeft: "11%", paddingRight: "11%"}}>  
      <section>
      <div className="mx-auto px-4" style={{paddingLeft: "11%", paddingRight: "11%"}}>
      <p className="text-sm text-blue-600 font-medium mb-2 text-center">FAQs</p>
    ...
    <FaqAccordion />
      ...
      <footer className="bg-[#0A2463] text-white" style={{paddingLeft: "10%", paddingRight: "10%", marginTop: "50px"}}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 p-10 text-whilte">
          ...
          <div className="md:col-span-2">
            <button onClick={() => window.location.href="/"} style={{ width: "200px", cursor: "pointer"}}><img src="logo_footer.svg" alt="Logo" className="mb-5" style={{maxWidth: "200px"}} /></button>
            <p className="text-xs">
              ...
              <li>
                ...
                {showModal && (
                  <div style={overlayStyle}>
                      ...
                      <button onClick={() => setShowModal(false)} style={closeButtonStyle} aria-label="Close Modal">
                        &times;
                      </button>
                      <h2 style={{ fontSize: "30px", textAlign: "center", color: "black" }}>Terms of Policy</h2>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            <a href="https://www.facebook.com"><img src="links/facebook.svg" alt="Facebook" /></a>
            <a href="https://www.linkedin.com"><img src="links/linkedin.svg" alt="LinkedIn" /></a>
            <a href="https://www.instagram.com"><img src="links/instagram.svg" alt="Instagram" /></a>
            <a href="https://www.twitter.com"><img src="links/twitter.svg" alt="Twitter" /></a>
          </div>
        </div>
      </footer>
    </div>
